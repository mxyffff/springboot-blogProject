...
import me.leedakyeom.springbootblogproject.dto.ArticleResponse;
...
public class BlogApiController {
    ...
    @GetMapping("/api/articles/{id}") // URL에서 {id}에 해당하는 값이 아래 id 매개변수로 드러옴
    // URL 경로에서 값 추출
    ...
    @DeleteMapping("/api/articles/{id}") // URL에서 id에 해당하는 값이 id로 들어옴
